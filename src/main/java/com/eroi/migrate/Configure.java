...
public class Configure {
	...
	public static final String PROPERTY_CONNECTION_DBNAME = "connection.dbname";
	...
	public static final String PROPERTY_DATABASE_VERSION_TABLE_PACKAGE = "database.version.table.package";
	...
	public static final String DEFAULT_PACKAGE_NAME = "db";
	 ...
	 *            Use the <code>PROPERTY_CONNECTION_*</code> or <code>PROPERTY_MIGRATION_*</code> constants defined by this class to fill your
	 *            property object
	 */
	public static void configure(Properties properties) {
		...
		cfg.database = properties.getProperty(PROPERTY_CONNECTION_DBNAME);
		cfg.packageName = properties.getProperty(PROPERTY_MIGRATION_PACKAGE_NAME);
		String versionTablePackage = properties.getProperty(PROPERTY_DATABASE_VERSION_TABLE_PACKAGE);
		if (versionTablePackage != null && !"".equals(versionTablePackage)) {
			cfg.setVersionTablePackage(versionTablePackage);
		}
	 ...
	 */
	public static void configure(String url, String driver, String username, String password, String connectionArguments, String packageName,
			String classprefix, String separator, Integer startIndex, String versionTable) {
	 ...
	 * @param packageName String package where Migration classes are located
	 */
	public static void configure(String url, String driver, String username, String password, String packageName) {

		configure(url, driver, username, password, null, packageName, null, null, null, null);
	}

	public static void configure(String url, String username, String password, String packageName) {

		configure(url, DEFAULT_DRIVER, username, password, packageName);
	}

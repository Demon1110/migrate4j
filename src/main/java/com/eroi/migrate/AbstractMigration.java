...
public abstract class AbstractMigration implements Migration {
	 ...
	 * to MySQL. While the <code>tableOptions</code> may be ignored for database products that do not
	...
	protected final Column column(final String columnName, final String columnComment, final DataTypes columnType,
			final Define.ColumnOption<?>... columnOption) {
		return Define.column(columnName, columnComment, columnType, columnOption);
	}
	...
	protected final Table table(final String tableName, final String tableComment, final Column... columns) {
		return Define.table(tableName, tableComment, columns);
	}
	 ...
	 * @return
	 */
	protected final ForeignKey foreignKey(final String name, final String parentTable, final String parentColumn, String childTable,
			String childColumn) {
	 ...
	 * @return
	 */
	protected final ForeignKey foreignKey(final String name, final String parentTable, final String parentColumn, final String childTable,
			final String childColumn, final CascadeRule deleteRule, final CascadeRule updateRule) {
	...
	protected final static DataTypes DATETIME = Define.DataTypes.DATETIME;
